...
student1 = Student("Matt", "Reeds", "MReeds", "C38")
student2 = Student("Tyler", "Weinhoff", "TWeinhoff", "C39")
student3 = Student("Jack", "Nichols", "JNickels", "C40")
student4 = Student("Jason", "Borne", "JBorne", "C38")
...
instructor1 = Instructor("Andy", "Collins", "ACollins", "C38")
instructor2 = Instructor("Jisie", "David", "JDavid", "C39")
instructor3 = Instructor("Steve", "Brownlee", "SBrownlee", "C40")
